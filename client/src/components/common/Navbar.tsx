...
export const Navbar: React.FC<NavbarProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-md border-t border-slate-800 px-2 py-1.5 safe-area-pb shadow-2xl">
        ...
        {tabs.map(tab => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] mt-1 font-medium tracking-tight truncate">
                {tab.label}
              </span>
            </button>
          );
